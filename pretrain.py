...
from model.dataloader.samplers import FewShotSampler
from model.utils.train_utils import pprint, set_gpu, ensure_path, Averager, Timer, count_acc, euclidean_metric
...
if __name__ == '__main__':
    ...
    args.save_path = osp.join(save_path1)
    ...
    valset.num_class = 5
    val_sampler = FewShotSampler(valset.label, 200, valset.num_class, 1 + args.query) # test on 5-way 1-shot
    val_loader = DataLoader(dataset=valset, batch_sampler=val_sampler, num_workers=8, pin_memory=True)
    args.way = valset.num_class    #valset.num_class
    args.shot = 1
